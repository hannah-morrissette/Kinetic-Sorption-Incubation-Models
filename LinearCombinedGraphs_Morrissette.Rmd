...
comp1 <- base + geom_function(fun = WLt, color = "red3", linetype = "dashed", size = 1.2) +
  geom_point(data = lfr, aes(time, DOC), shape = 21, color = "black", fill = "white") +
  geom_point(data = lfk, aes(time, DOC), shape = 21, color = "black", fill = "red3") +
  geom_function(fun = WHt, color = "salmon", linetype = "dashed", size = 1.2) +
  geom_point(data = hfr, aes(time, DOC), shape = 21, color = "black", fill = "white") +
  geom_point(data = hfk, aes(time, DOC), shape = 21, color = "black", fill = "salmon") +
  theme_minimal() +
...
comp2 <- base + geom_function(fun = WLt, color = "red3", linetype = "dashed", size = 1.2) +
  geom_point(data = lsk, aes(time, DOC), shape = 21, color = "black", fill = "red3") +
  geom_point(data = lsr, aes(time, DOC), shape = 21, color = "black", fill = "white") +
  geom_function(fun = WHt, color = "salmon", linetype = "dashed", size = 1.2) +
  geom_point(data = hsk, aes(time, DOC), shape = 21, color = "black", fill = "salmon") +
  geom_point(data = hsr, aes(time, DOC), shape = 21, color = "black", fill = "white") +
  theme_minimal() +
